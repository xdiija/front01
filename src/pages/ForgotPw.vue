  ...
  <q-page class="flex flex-center bg-primary">
    <q-card style="width: 300px; height: auto; display: flex; flex-direction: column; align-items: center">
      ...
      <q-card-section class="full-width">
        ...
        <div class="text-caption">Type your e-mail to recover your password</div>
      </q-card-section>
      ...
      <q-card-actions class="full-width">
         <q-btn outline class="q-mx-sm" color="primary" label="Change Password" @click="$router.push({ name: 'login'})" style="width: 100%" />
      </q-card-actions>
    </q-card>
